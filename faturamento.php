...
<?php
    ...
    if(isset($_POST['addTransacoes'])){
    
        $servicos_id = (int)$_POST['idServicos'];
        $nomeServicos = $_POST['nomeServicos'];

        $idExtrato = 1;

        $sqlGetExtrato="select * from transacoes where FK_extrato={$idExtrato} AND FK_PRODUTO ={$product_id}";
        $queryGetextrato= mysqli_query($con, $sqlGetextrato);
        $resultextrato=mysqli_fetch_assoc($queryGetextrato);

        $Existeextrato = isset($resultextrato);    
        if(isset($resultextrato)){
            
            $sqlAddOrUpdate = "
            UPDATE transacoes set QTD_PRODUTO={$quantity} 
            WHERE FK_PRODUTO ={$product_id} and FK_extrato={$idExtrato};
            ";

        }else{
            $sqlAddOrUpdate = "
            INSERT INTO transacoes (FK_PRODUTO,FK_extrato) 
            VALUES ({$servicos_id}, {$idExtrato});
            ";
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="soft-ui-dashboard-main/pages/billing.html">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="soft-ui-dashboard-main/pages/virtual-reality.html">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          ...
          <div class="row">
            <div class="col-xl-6 mb-xl-0 mb-4">
              <div class="card bg-transparent shadow-xl">
                <div class="overflow-hidden position-relative border-radius-xl" style="background-image: url('soft-ui-dashboard-main/assets/img/curved-images/curved14.jpg');">
